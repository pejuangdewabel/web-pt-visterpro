    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a class="navbar-brand" href="index.html"><h2>Artikel Vister Pro<em>.</em></h2></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('artikel') }}">Home
                    <span class="sr-only">(current)</span>
                    </a>
                </li> 
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('artikel-all') }}">Artikel</a>
                </li>
                <li class="nav-item">
